    ...
    <Container maxWidth="md" sx={{ py: 12 }}>
      <Box>
        ...
        <Typography variant="body2">
          ...
          at{' '}
          <Typography component="a" href="https://cruxfinance.io" target="_blank" rel="noopener" color="primary">
            https://cruxfinance.io
          </Typography>{' '}
          (hereinafter referred to as the &quot;Website&quot;) and the services provided by Crux Finance (hereinafter referred
          to as the &quot;Company&quot; or &quot;We&quot; or &quot;Us&quot;). These Terms constitute a binding and
        ...
        <List sx={listStyle}>
          ...
          <ListItem>
            <Typography>&quot;Platform&quot; refers to Crux Finance, the online platform operated by the Company.</Typography>
          </ListItem>
          <ListItem>
          ...
          <ListItem>
            <Typography>
              &quot;Tokens&quot; refers to Crux Tokens (CRX) and other Project Tokens available on the Platform.
            </Typography>
          </ListItem>
          <ListItem>
            <Typography>
        ...
        <Typography variant="body2">
          3.6 Eligibility: As a user of the Interface, you declare and guarantee that you are not presently subjected to any economic or
        ...
        <Typography variant="body2">
          5.7 Severability: If any provision of these Terms is found to be invalid, illegal, or unenforceable, the remaining
          provisions shall continue to be valid and enforceable to the fullest extent permitted by law.
        </Typography>

        <Typography variant="body2">
          5.8 Suspension or Termination of Services: The Company reserves the right to suspend or terminate your access to the
        ...
        <Typography variant="body2">
          5.9 Modification of Services: The Company reserves the right to modify, update, or discontinue certain features or
...
export default CruxTermsOfService;